...
with(mydata,plot(eff~log10(mass),pch = 19, col = mydata$order, font.lab = 2, las = 1, ylab = NA, xlab = NA))
title(ylab=expression(bold(paste("Effective hind-limb length"))),
...
palette(c("#db362f", "#feb629", "#2fa3cc")) 
legend(-2.4,0.95, legend = levels(mydata$order), col = 1:3, pch = 19, bty = "n") 
palette(c("#c34214", "#fe9929", "#2c7fb8")) 
legend(-2.495,0.95, legend = levels(mydata$order), col = 1:3, lty = "solid", bty = "n", text.col = blank, lwd = 2.5, seg.len=1) 

text(2.7, 0.725, expression(bold(paste("Y = 0.0451x + 0.783"))), cex = 0.8, col = "#c34214")
text(2.7, 0.7, expression(bold(paste("R", ''^{2}, "= 0.429", sep = ""))), cex = 0.8, col = "#c34214")

text(2.1, 0.625, expression(bold(paste("Y = 0.0627x + 0.729"))), cex = 0.8, col = "#fe9929")
text(2.1, 0.6, expression(bold(paste("R", ''^{2}, "= 0.395", sep = ""))), cex = 0.8, col = "#fe9929")

text(1.4, 0.525, expression(bold(paste("Y = 0.0448x + 0.647"))), cex = 0.8, col = "#2c7fb8")
text(1.4, 0.5, expression(bold(paste("R", ''^{2}, "= 0.25", sep = ""))), cex = 0.8, col = "#2c7fb8")
...
logoing_func(Art_logo, x=0.87, y=0.625, size=0.1)
logoing_func(Car_logo, x=0.77, y=0.425, size=0.1)
logoing_func(Rod_logo, x=0.67, y=0.225, size=0.1)
